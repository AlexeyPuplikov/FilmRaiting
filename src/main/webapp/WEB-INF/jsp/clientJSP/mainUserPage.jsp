...
<header>
    <div class="container">
        <div class="change-language">
            <a href="<c:url value="/controller?command=CHANGE_LANGUAGE&locale=ru"/>"><img
                    src="<c:url value="/resources/images/lang-ru.png"/>"></a>
            <a href="<c:url value="/controller?command=CHANGE_LANGUAGE&locale=en"/>"><img
...
<main>
    ...
    <pagedTag:getPaged numberOfRecords="${films.size()}" recordsPerPage="${pageContext.servletContext.getInitParameter('recordsPerPage')}">
        <jsp:body>
            <div class="container">
                <div class="row">
